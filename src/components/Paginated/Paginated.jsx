        ...
        <div className={style.divContainer}>
            <div className={style.divButton}>
                <button className={style.prev} disabled={page === 1} onClick={prevPage}>
                    <svg viewBox="0 0 20 27" fill="none" xmlns="http://www.w3.org/2000/svg" className={style.svg}>
                        <path
                ...
                <button className={style.next} onClick={nextPage} disabled={page === max}>
                    <svg width="20" height="27" viewBox="0 0 20 27" fill="none" xmlns="http://www.w3.org/2000/svg" className={style.svg}>
                        <path
